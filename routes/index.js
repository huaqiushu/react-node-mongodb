...
dbHandle=require("../dbbase/dbHandle.js");
...
router.get('/getNotes', function(req,res,next){/*请求参数，相应参数和负责把错误信息运送出来的next参数*/
  var noteModel=dbHandle.getModel("notes");/*获取note数据库模型，模型能直接对数据库进行操作*/
...
router.post('/addNote', function(req,res,next){
  ...
  var noteModel=dbHandle.getModel("notes");
  console.log(newNote);
